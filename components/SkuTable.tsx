...
const SkuTable: React.FC<SkuTableProps> = ({ data, onRowClick }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-850 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors duration-200">
      <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <h2 className="text-lg font-bold text-gray-800 dark:text-brand-100">SKU Details</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative flex-1 sm:flex-none">
                ...
                <input
                  type="text"
                  className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent bg-white dark:bg-gray-750 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 transition-colors duration-200 w-full"
                  placeholder="Search..."
                  value={searchTerm}
              ...
              <div className="relative flex-1 sm:flex-none">
                ...
                <select
                  className="pl-10 pr-8 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent appearance-none bg-white dark:bg-gray-750 text-gray-900 dark:text-gray-100 transition-colors duration-200 w-full truncate max-w-[200px]"
      ...
      <div className="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
        {filteredData.length > 0 ? (
          ...
          >
              ...
              <div className="grid grid-cols-3 gap-2 text-sm pt-2 border-t border-gray-100 dark:border-gray-700/50">
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-500 mb-0.5">Turnover</div>
                  <div className="font-medium text-gray-700 dark:text-gray-300">{item.turnover} days</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-xs text-gray-500 dark:text-gray-500 mb-0.5">Inv.</div>
                  <div className="font-medium text-gray-900 dark:text-gray-200">${item.investment.toLocaleString(undefined, { maximumFractionDigits: 0 })}</div>
                </div>
                <div className="text-right">
                  <div className="text-xs text-gray-500 dark:text-gray-500 mb-0.5">Profit</div>
      ...
      <div className="bg-gray-50 dark:bg-gray-750 px-6 py-3 text-xs text-gray-500 dark:text-gray-400 border-t border-gray-100 dark:border-gray-700 transition-colors duration-200">
